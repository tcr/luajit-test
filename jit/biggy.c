...
static const uint16_t build_actionlist[9283] = {
0xffff,
0x1001,
0xffff,
0x6014,
...
#line 305 "biggy.dasc"
  ...
  //|  b ->vm_leave_unw
  dasm_put(Dst, 96, Dt1(->top), Dt1(->cframe), Dt1(->maxstack), ~LJ_TNIL, Dt1(->top), Dt1(->top), LJ_VMST_C, Dt1(->glref), Dt2(->vmstate));
#line 354 "biggy.dasc"
  //|
  ...
  dasm_put(Dst, 180, ~CFRAME_RAWMASK, Dt1(->base), Dt1(->glref), ~LJ_TFALSE, GG_G2DISP, LJ_VMST_INTERP, DISPATCH_GL(vmstate), LUA_MINSTACK, Dt1(->base), Dt1(->top), Dt1(->base), Dt1(->top), Dt7(->field_pc));
#line 403 "biggy.dasc"
  //|
  //|//-----------------------------------------------------------------------
  ...
  //|  saveregs
  dasm_put(Dst, 270, 2, 5, Dt1(->glref), GG_G2DISP, FRAME_CP, CFRAME_RESUME, Dt1(->status), Dt1(->cframe), Dt1(->base), Dt1(->top), Dt1(->status), LJ_VMST_INTERP, FRAME_TYPE, DISPATCH_GL(vmstate), FRAME_CP);
#line 454 "biggy.dasc"
  //|  mov PC, #FRAME_C
  //|
  ...
  dasm_put(Dst, 372, FRAME_C, Dt1(->cframe), Dt1(->cframe), Dt1(->glref), GG_G2DISP, Dt1(->base), Dt1(->top), LJ_VMST_INTERP, DISPATCH_GL(vmstate), -LJ_TFUNC, Dt7(->field_pc), 2, 5, Dt1(->stack), Dt1(->top), Dt1(->cframe));
#line 498 "biggy.dasc"
  //|  str sp, L->cframe			// Add our C frame to cframe chain.
  //|  mov RB, #0
  ...
  //|2:
  //|   mvn CARG4, #~LJ_TSTR
  dasm_put(Dst, 470, Dt1(->cframe), Dt1(->glref), FRAME_CP, GG_G2DISP, Dt7(->field_pc), ~LJ_TNIL, PC2PROTO(k), Dt1(->base), 21, 5, -DISPATCH_GL(tmptv), ~LJ_TTAB);
#line 576 "biggy.dasc"
  //|  str STR:RC, TMPDlo
  //|   str CARG4, TMPDhi
  //|  mov CARG3, TMPDp
  ...
  //|   mvn CARG4, #~LJ_TTAB
  //|  str TAB:RB, [CARG2]
  dasm_put(Dst, 577, ~LJ_TSTR, 21, ~LJ_TISNUM, Dt1(->base), 2, 5, FRAME_CONT, Dt1(->top), -DISPATCH_GL(tmptv), ~LJ_TTAB);
#line 628 "biggy.dasc"
  //|   str CARG4, [CARG2, #4]
  //|2:
  //|   mvn CARG4, #~LJ_TSTR
  ...
  //|  .IOS ldr BASE, L->base
  //|  cmp CRET1, #1
  dasm_put(Dst, 675, ~LJ_TSTR, 21, ~LJ_TISNUM, Dt1(->base), 2, 5, FRAME_CONT, Dt1(->top), Dt1(->base));
#line 690 "biggy.dasc"
  //|  bhi ->vmeta_binop
  //|4:
  //|  ldrh RB, [PC, #2]
  ...
  //|  decode_RB8 RB, INS
  //|   decode_RC8 RC, INS
  dasm_put(Dst, 781, 2, 2, 5, 5, ~LJ_TTRUE, -LJ_TFALSE, Dt1(->base), 21);
#line 744 "biggy.dasc"
  //|  add CARG3, BASE, RB
  //|   add CARG4, KBASE, RC
  //|  b >1
  ...
  //|  .IOS ldr BASE, L->base
  dasm_put(Dst, 871, 13, 21, 13, 21, 13, Dt1(->base), FRAME_CONT, Dt1(->base));
#line 798 "biggy.dasc"
#if LJ_52
  //|  cmp CRET1, #0
...
#line 805 "biggy.dasc"
  ...
  //|  bne <1
  //|  b ->fff_res
  dasm_put(Dst, 979, Dt1(->base), Dt7(->field_pc), 2, 5, Dt1(->base), Dt1(->base), 5, BC_FORI, -LJ_TTRUE);
#line 944 "biggy.dasc"
  //|
  //|.ffunc type
  //|  ldr CARG2, [BASE, #4]
  ...
  dasm_put(Dst, 1099, -LJ_TISNUM, ~LJ_TISNUM, (int)(offsetof(GCfuncC, upvalue)>>3)-1, -LJ_TTAB, -LJ_TUDATA, Dt6(->metatable), ~LJ_TNIL, DISPATCH_GL(gcroot[GCROOT_MMNAME+MM_metatable]), Dt6(->hmask), Dt5(->hash), Dt6(->node), 1);
#line 975 "biggy.dasc"
  ...
  dasm_put(Dst, 1184, 3, DtB(->key), DtB(->val), DtB(->next), -LJ_TSTR, ~LJ_TTAB, -LJ_TNIL, -LJ_TISNUM, ~LJ_TISNUM, 2, DISPATCH_GL(gcroot[GCROOT_BASEMT]));
#line 1002 "biggy.dasc"
  ...
  //|  ldrd CARG1, CARG2, [BASE]
  dasm_put(Dst, 1263, -LJ_TTAB, Dt6(->metatable), -LJ_TTAB, Dt6(->marked), LJ_GC_BLACK, Dt6(->metatable), DISPATCH_GL(gc.grayagain), LJ_GC_BLACK, DISPATCH_GL(gc.grayagain), Dt6(->marked), Dt6(->gclist), -LJ_TTAB);
#line 1035 "biggy.dasc"
  ...
  dasm_put(Dst, 1353, -LJ_TISNUM, -LJ_TSTR, DISPATCH_GL(gcroot[GCROOT_BASEMT_NUM]), Dt1(->base), -LJ_TISNUM, DISPATCH_GL(gc.total), DISPATCH_GL(gc.threshold), Dt1(->base), ~LJ_TSTR, ~LJ_TNIL);
#line 1067 "biggy.dasc"
  ...
  //|.ffunc_1 pairs
  //|  checktab CARG2, ->fff_fallback
  dasm_put(Dst, 1445, -LJ_TTAB, Dt1(->base), Dt1(->top), ~LJ_TNIL, (2+1)*8, -LJ_TTAB);
#line 1090 "biggy.dasc"
#if LJ_52
  //|  ldr TAB:RB, TAB:CARG1->metatable
  dasm_put(Dst, 1512, Dt6(->metatable));
#line 1092 "biggy.dasc"
#endif
  //|   ldrd CFUNC:CARG3, CFUNC:CARG4, CFUNC:CARG3->upvalue[0]
  //|    ldr PC, [BASE, FRAME_PC]
  dasm_put(Dst, 1517, Dt8(->upvalue[0]));
...
#line 1098 "biggy.dasc"
  ...
  //|  beq ->fff_res
  //|  ldrd CARG1, CARG2, [CRET1]
  dasm_put(Dst, 1531, ~LJ_TNIL, (3+1)*8, -LJ_TTAB, -LJ_TISNUM, Dt6(->asize), Dt6(->array), 3, (0+1)*8, -LJ_TNIL, (2+1)*8, Dt6(->hmask));
#line 1136 "biggy.dasc"
  //|  b <1
  //|
  //|.ffunc_1 ipairs
  //|  checktab CARG2, ->fff_fallback
  dasm_put(Dst, 1629, -LJ_TTAB);
#line 1140 "biggy.dasc"
#if LJ_52
  //|  ldr TAB:RB, TAB:CARG1->metatable
  dasm_put(Dst, 1651, Dt6(->metatable));
#line 1142 "biggy.dasc"
#endif
  //|   ldrd CFUNC:CARG3, CFUNC:CARG4, CFUNC:CARG3->upvalue[0]
  //|    ldr PC, [BASE, FRAME_PC]
  dasm_put(Dst, 1656, Dt8(->upvalue[0]));
...
#line 1148 "biggy.dasc"
  ...
  dasm_put(Dst, 1670, ~LJ_TISNUM, (3+1)*8, DISPATCH_GL(hookmask), HOOK_ACTIVE, 8+FRAME_PCALL, 8+FRAME_PCALLH, DISPATCH_GL(hookmask), -LJ_TFUNC, HOOK_ACTIVE, 16+FRAME_PCALL, 16+FRAME_PCALLH, -LJ_TTHREAD);
  dasm_put(Dst, 1777, Dt1(->base), Dt1(->top), Dt1(->status), Dt1(->base), Dt1(->maxstack), Dt1(->cframe), LUA_YIELD, Dt1(->top), Dt1(->top), Dt1(->base), LJ_VMST_INTERP, Dt1(->top), DISPATCH_GL(vmstate), LUA_YIELD);
#line 1295 "biggy.dasc"
  //|  coroutine_resume_wrap 0		// coroutine.wrap
  dasm_put(Dst, 1873, Dt1(->base), Dt1(->maxstack), Dt1(->top), ~LJ_TTRUE, FRAME_TYPE, ~LJ_TFALSE, (2+1)*8, Dt1(->top));
  dasm_put(Dst, 1971, Dt8(->upvalue[0].gcr), Dt1(->base), Dt1(->top), Dt1(->status), Dt1(->base), Dt1(->maxstack), Dt1(->cframe), LUA_YIELD, Dt1(->top), Dt1(->top), Dt1(->base), LJ_VMST_INTERP, Dt1(->top), DISPATCH_GL(vmstate), LUA_YIELD);
#line 1296 "biggy.dasc"
  ...
  //|   str CARG2, L->top
  //|    mov CRET1, #LUA_YIELD
  dasm_put(Dst, 2061, Dt1(->base), Dt1(->maxstack), Dt1(->top), FRAME_TYPE, Dt1(->cframe), Dt1(->base), CFRAME_RESUME, Dt1(->top));
#line 1304 "biggy.dasc"
  ...
  //|
  //|  math_round floor
  dasm_put(Dst, 2152, LUA_YIELD, Dt1(->cframe), Dt1(->status), -LJ_TISNUM, 21, 21, 31, ~LJ_TISNUM, 31, ~LJ_TISNUM);
#line 1376 "biggy.dasc"
  //|  math_round ceil
  dasm_put(Dst, 2255, -LJ_TISNUM, 21, 21, 31, ~LJ_TISNUM);
#line 1377 "biggy.dasc"
  ...
  //|  ands CARG1, PC, #FRAME_TYPE
  dasm_put(Dst, 2360, 31, ~LJ_TISNUM, -LJ_TISNUM, (1+1)*8);
#line 1402 "biggy.dasc"
  ...
  //|.else
  //|  b ->fff_restv
  dasm_put(Dst, 2456, FRAME_TYPE, 21, 5, 2, 5, ~LJ_TNIL, -LJ_TISNUM, -LJ_TISNUM);
#line 1487 "biggy.dasc"
  ...
  //|  math_extern sin
  //|  math_extern cos
  dasm_put(Dst, 2553, -LJ_TISNUM, -LJ_TISNUM, -LJ_TISNUM, -LJ_TISNUM);
#line 1493 "biggy.dasc"
  //|  math_extern tan
  //|  math_extern asin
  //|  math_extern acos
  //|  math_extern atan
  dasm_put(Dst, 2636, -LJ_TISNUM, -LJ_TISNUM, -LJ_TISNUM);
#line 1497 "biggy.dasc"
  //|  math_extern sinh
  //|  math_extern cosh
  //|  math_extern tanh
  dasm_put(Dst, 2716, -LJ_TISNUM, -LJ_TISNUM, -LJ_TISNUM, -LJ_TISNUM);
#line 1500 "biggy.dasc"
  ...
  //|.else
  //|  .ffunc_n math_rad
  dasm_put(Dst, 2801, -LJ_TISNUM, -LJ_TISNUM, -LJ_TISNUM, -LJ_TISNUM, -LJ_TISNUM, -LJ_TISNUM);
#line 1512 "biggy.dasc"
  ...
  //|.else
  //|.ffunc_n math_modf
  dasm_put(Dst, 2897, -LJ_TISNUM, Dt8(->upvalue[0]), -LJ_TISNUM, -LJ_TISNUM, -LJ_TISNUM, ~LJ_TISNUM, (2+1)*8);
#line 1584 "biggy.dasc"
  ...
  dasm_put(Dst, 2994, -LJ_TISNUM, (2+1)*8, -LJ_TISNUM, -LJ_TISNUM);
#line 1687 "biggy.dasc"
  //|  math_minmax math_max, lt, lo
  dasm_put(Dst, 3086, -LJ_TISNUM, -LJ_TISNUM, -LJ_TISNUM);
#line 1688 "biggy.dasc"
  ...
  //|  ldrd CARG1, CARG2, [BASE]
  dasm_put(Dst, 3180, -LJ_TISNUM, -LJ_TSTR, Dt5(->len), ~LJ_TISNUM);
#line 1699 "biggy.dasc"
  ...
  //|.ffunc string_sub
  //|  ffgccheck
  dasm_put(Dst, 3265, -LJ_TSTR, Dt5(->len), Dt5([1]), ~LJ_TISNUM, (0+1)*8, (1+1)*8, DISPATCH_GL(gc.total), DISPATCH_GL(gc.threshold), -LJ_TISNUM, Dt1(->base), Dt1(->base), ~LJ_TSTR, DISPATCH_GL(gc.total));
#line 1736 "biggy.dasc"
  ...
  //|  ffgccheck
  //|  ldrd CARG1, CARG2, [BASE]
  dasm_put(Dst, 3366, DISPATCH_GL(gc.threshold), -LJ_TISNUM, -LJ_TSTR, Dt5(->len), -LJ_TISNUM, 31, sizeof(GCstr)-1, -DISPATCH_GL(strempty), ~LJ_TSTR, DISPATCH_GL(gc.total), DISPATCH_GL(gc.threshold));
#line 1775 "biggy.dasc"
  ...
  //|  checkstr CARG2, ->fff_fallback
  //|  ldr CARG3, STR:CARG1->len
  dasm_put(Dst, 3474, -LJ_TSTR, -LJ_TISNUM, Dt5(->len), DISPATCH_GL(tmpbuf.sz), DISPATCH_GL(tmpbuf.buf), Dt5([1]), DISPATCH_GL(gc.total), DISPATCH_GL(gc.threshold), -LJ_TSTR);
#line 1805 "biggy.dasc"
  ...
  dasm_put(Dst, 3564, Dt5(->len), DISPATCH_GL(tmpbuf.sz), DISPATCH_GL(tmpbuf.buf), sizeof(GCstr), DISPATCH_GL(gc.total), DISPATCH_GL(gc.threshold), -LJ_TSTR, Dt5(->len), DISPATCH_GL(tmpbuf.sz), DISPATCH_GL(tmpbuf.buf), sizeof(GCstr));
#line 1845 "biggy.dasc"
  ...
  //|  mvn CARG2, #~LJ_TISNUM
  //|  b ->fff_restv
  dasm_put(Dst, 3654, DISPATCH_GL(gc.total), DISPATCH_GL(gc.threshold), -LJ_TSTR, Dt5(->len), DISPATCH_GL(tmpbuf.sz), DISPATCH_GL(tmpbuf.buf), sizeof(GCstr), -LJ_TTAB, ~LJ_TISNUM);
#line 1857 "biggy.dasc"
  ...
  dasm_put(Dst, 3757, 21, 21, -LJ_TISNUM, ~LJ_TISNUM, -LJ_TISNUM, -LJ_TISNUM);
#line 1914 "biggy.dasc"
  ...
  //|
  //|.ffunc_bit bswap
  dasm_put(Dst, 3874, -LJ_TISNUM, -LJ_TISNUM, -LJ_TISNUM, -LJ_TISNUM, ~LJ_TISNUM);
#line 1924 "biggy.dasc"
  ...
  dasm_put(Dst, 3982, -LJ_TISNUM, 16, ~LJ_TISNUM, 8, -LJ_TISNUM, ~LJ_TISNUM, -LJ_TISNUM, -LJ_TISNUM, ~LJ_TISNUM);
#line 1958 "biggy.dasc"
  //|.ffunc_bit_sh arshift, asr, 0
  //|.ffunc_bit_sh rol, ror, 1
  dasm_put(Dst, 4084, -LJ_TISNUM, -LJ_TISNUM, ~LJ_TISNUM, -LJ_TISNUM, -LJ_TISNUM, ~LJ_TISNUM, -LJ_TISNUM, -LJ_TISNUM, ~LJ_TISNUM);
#line 1960 "biggy.dasc"
  ...
  dasm_put(Dst, 4197, -LJ_TISNUM, -LJ_TISNUM, ~LJ_TISNUM, Dt1(->maxstack), Dt1(->top), Dt8(->f), Dt1(->base), 8*LUA_MINSTACK, Dt1(->base), Dt1(->top), Dt7(->field_pc));
#line 1991 "biggy.dasc"
  ...
  //|  decode_OP OP, INS
  dasm_put(Dst, 4295, 2, 5, FRAME_TYPE, FRAME_TYPEP, 5, LUA_MINSTACK, Dt1(->base), Dt1(->base), Dt1(->top), Dt1(->base), DISPATCH_GL(hookmask), HOOK_ACTIVE);
#line 2048 "biggy.dasc"
  ...
  //|   decode_RA8 RA, INS
  //|   decode_RD RC, INS
  dasm_put(Dst, 4389, 2, GG_DISP2STATIC, DISPATCH_GL(hookmask), DISPATCH_GL(hookcount), HOOK_ACTIVE, LUA_MASKLINE|LUA_MASKCOUNT, DISPATCH_GL(hookcount), LUA_MASKLINE, Dt1(->base), Dt1(->base), 2, GG_DISP2STATIC, 5);
#line 2078 "biggy.dasc"
  ...
  //|->vm_ceil_sf:
  //|  vm_round ceil, 0
  dasm_put(Dst, 4474, Dt1(->base), Dt1(->top), Dt1(->base), Dt1(->top), 21, 31, 31);
#line 2290 "biggy.dasc"
  ...
  //|  nop
  dasm_put(Dst, 4610, 21, 31, 31, 1, 3);
...
#line 2501 "biggy.dasc"
  ...
  case BC_ISLT: case BC_ISGE: case BC_ISLE: case BC_ISGT:
    ...
    //|  bne >4
    //|  cmp CARG1, CARG3
    dasm_put(Dst, 4790, 2, -LJ_TISNUM, -LJ_TISNUM);
...
#line 2602 "biggy.dasc"
  ...
  case BC_ISEQV: case BC_ISNEV:
    ...
    dasm_put(Dst, 4926, 2, -LJ_TISNUM, -LJ_TISNUM);
...
#line 2633 "biggy.dasc"
    if (vk) {
      ...
      dasm_put(Dst, 4972, 2, 5, -LJ_TISTABUD);
#line 2642 "biggy.dasc"
    } else {
      //|  beq >1				// Same GCobjs or pvalues?
      //|  checktp CARG2, LJ_TISTABUD
      //|  bhi >2				// Different objects and not table/ud?
      dasm_put(Dst, 5004, -LJ_TISTABUD);
#line 2646 "biggy.dasc"
    ...
    //|  cmp TAB:RA, #0
    dasm_put(Dst, 5016, Dt6(->metatable));
...
#line 2655 "biggy.dasc"
    ...
    dasm_put(Dst, 5032, Dt6(->nomm), 1-vk, 1<<MM_eq);
...
#line 2717 "biggy.dasc"
    ...
    //|  bne >4
    //|  cmp CARG1, CARG3
    dasm_put(Dst, 5141, -LJ_TISNUM, -LJ_TISNUM);
...
#line 2811 "biggy.dasc"
  ...
  case BC_ISTC: case BC_ISFC: case BC_IST: case BC_ISF:
    ...
    //|   add RB, PC, RB, lsl #2
    //|  checktp CARG2, LJ_TTRUE
    dasm_put(Dst, 5276, 3, 2, -LJ_TTRUE);
...
#line 2847 "biggy.dasc"
  ...
  case BC_NOT:
    ...
    //|  str CARG2, [RA, #4]
    //|   ins_next3
    dasm_put(Dst, 5344, 3, -LJ_TTRUE, ~LJ_TFALSE, ~LJ_TTRUE, 2, 5);
#line 2860 "biggy.dasc"
  ...
  case BC_UNM:
    ...
    //|9:
    //|  .long 0x00000000, 0x41e00000	// 2^31.
    dasm_put(Dst, 5378, -LJ_TISNUM, 2, 5);
#line 2880 "biggy.dasc"
  ...
  case BC_LEN:
    ...
    dasm_put(Dst, 5427, -LJ_TSTR, Dt5(->len), ~LJ_TISNUM, 2, 5, -LJ_TTAB);
#line 2895 "biggy.dasc"
    ...
    //|  bne >9
    //|3:
    dasm_put(Dst, 5471, Dt6(->metatable));
...
#line 2907 "biggy.dasc"
    ...
    //|  b ->vmeta_len
    dasm_put(Dst, 5493, Dt6(->nomm), 1<<MM_len);
#line 2913 "biggy.dasc"
  ...
  case BC_ADDVN: case BC_ADDNV: case BC_ADDVV:
    ...
    dasm_put(Dst, 5538);
    if (vk == 1) {
    dasm_put(Dst, 5541, -LJ_TISNUM, -LJ_TISNUM);
    } else {
    dasm_put(Dst, 5551, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 5562);
    switch (vk) {
    case 0:
    ...
    dasm_put(Dst, 5584, 2, 5);
    switch (vk) {
    case 0:
    if (vk == 1) {
    dasm_put(Dst, 5603, -LJ_TISNUM, -LJ_TISNUM);
    } else {
    dasm_put(Dst, 5613, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 5624);
      break;
    case 1:
    if (vk == 1) {
    dasm_put(Dst, 5630, -LJ_TISNUM, -LJ_TISNUM);
    } else {
    dasm_put(Dst, 5640, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 5651);
      break;
    default:
    ...
    dasm_put(Dst, 5667, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 5678);
      break;
    }
...
#line 3077 "biggy.dasc"
  ...
  case BC_SUBVN: case BC_SUBNV: case BC_SUBVV:
    ...
    dasm_put(Dst, 5722);
    if (vk == 1) {
    dasm_put(Dst, 5725, -LJ_TISNUM, -LJ_TISNUM);
    } else {
    dasm_put(Dst, 5735, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 5746);
    switch (vk) {
    case 0:
    ...
    dasm_put(Dst, 5768, 2, 5);
    switch (vk) {
    case 0:
    if (vk == 1) {
    dasm_put(Dst, 5787, -LJ_TISNUM, -LJ_TISNUM);
    } else {
    dasm_put(Dst, 5797, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 5808);
      break;
    case 1:
    if (vk == 1) {
    dasm_put(Dst, 5814, -LJ_TISNUM, -LJ_TISNUM);
    } else {
    dasm_put(Dst, 5824, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 5835);
      break;
    default:
    if (vk == 1) {
    dasm_put(Dst, 5841, -LJ_TISNUM, -LJ_TISNUM);
    } else {
    dasm_put(Dst, 5851, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 5862);
      break;
    }
...
#line 3080 "biggy.dasc"
  ...
  case BC_MULVN: case BC_MULNV: case BC_MULVV:
    ...
    dasm_put(Dst, 5906);
    if (vk == 1) {
    dasm_put(Dst, 5909, -LJ_TISNUM, -LJ_TISNUM);
    } else {
    dasm_put(Dst, 5919, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 5930, 31);
    switch (vk) {
    case 0:
    dasm_put(Dst, 5942);
      break;
    ...
    dasm_put(Dst, 5957, 2, 5);
    switch (vk) {
    case 0:
    if (vk == 1) {
    dasm_put(Dst, 5976, -LJ_TISNUM, -LJ_TISNUM);
    } else {
    dasm_put(Dst, 5986, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 5997);
      break;
    case 1:
    ...
    dasm_put(Dst, 6013, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 6024);
      break;
    default:
    if (vk == 1) {
    dasm_put(Dst, 6030, -LJ_TISNUM, -LJ_TISNUM);
    } else {
    dasm_put(Dst, 6040, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 6051);
      break;
    }
...
#line 3083 "biggy.dasc"
  ...
  case BC_DIVVN: case BC_DIVNV: case BC_DIVVV:
    ...
    case 0:
    if (vk == 1) {
    dasm_put(Dst, 6095, -LJ_TISNUM, -LJ_TISNUM);
    } else {
    dasm_put(Dst, 6105, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 6116);
      break;
    case 1:
    ...
    dasm_put(Dst, 6132, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 6143);
      break;
    default:
    if (vk == 1) {
    dasm_put(Dst, 6149, -LJ_TISNUM, -LJ_TISNUM);
    } else {
    dasm_put(Dst, 6159, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 6170);
      break;
    }
    dasm_put(Dst, 6176, 2, 5);
#line 3086 "biggy.dasc"
    break;
  case BC_MODVN: case BC_MODNV: case BC_MODVV:
    //|  ins_arithdn vm_modi, vm_mod, ->vm_mod
    dasm_put(Dst, 6196, 21, 13);
    vk = ((int)op - BC_ADDVN) / (BC_ADDNV-BC_ADDVN);
    switch (vk) {
    case 0:
    dasm_put(Dst, 6206);
    ...
    dasm_put(Dst, 6267, ~LJ_TISNUM, 2, 5);
    switch (vk) {
    case 0:
    if (vk == 1) {
    dasm_put(Dst, 6295, -LJ_TISNUM, -LJ_TISNUM);
    } else {
    dasm_put(Dst, 6305, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 6316);
      break;
    case 1:
    if (vk == 1) {
    dasm_put(Dst, 6322, -LJ_TISNUM, -LJ_TISNUM);
    } else {
    dasm_put(Dst, 6332, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 6343);
      break;
    default:
    if (vk == 1) {
    dasm_put(Dst, 6349, -LJ_TISNUM, -LJ_TISNUM);
    } else {
    dasm_put(Dst, 6359, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 6370);
      break;
    }
...
#line 3089 "biggy.dasc"
  ...
  case BC_POW:
    ...
    case 0:
    if (vk == 1) {
    dasm_put(Dst, 6413, -LJ_TISNUM, -LJ_TISNUM);
    } else {
    dasm_put(Dst, 6423, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 6434);
      break;
    case 1:
    if (vk == 1) {
    dasm_put(Dst, 6440, -LJ_TISNUM, -LJ_TISNUM);
    } else {
    dasm_put(Dst, 6450, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 6461);
      break;
    default:
    if (vk == 1) {
    dasm_put(Dst, 6467, -LJ_TISNUM, -LJ_TISNUM);
    } else {
    dasm_put(Dst, 6477, -LJ_TISNUM, -LJ_TISNUM);
    }
    dasm_put(Dst, 6488);
      break;
    }
    dasm_put(Dst, 6494, 2, 5);
#line 3093 "biggy.dasc"
  ...
  case BC_CAT:
    ...
    //|   ins_next3
    dasm_put(Dst, 6514, 21, 13, Dt1(->base), Dt1(->base), 2, 5);
#line 3117 "biggy.dasc"
  ...
  case BC_KSTR:
    ...
    //|  strd CARG1, CARG2, [BASE, RA]
    //|   ins_next3
    dasm_put(Dst, 6561, 2, ~LJ_TSTR, 2, 5);
#line 3130 "biggy.dasc"
  ...
  case BC_KSHORT:
    ...
    //|  strd CARG1, CARG2, [BASE, RA]
    //|   ins_next3
    dasm_put(Dst, 6585, ~LJ_TISNUM, 2, 5);
...
#line 3169 "biggy.dasc"
  ...
  case BC_KNIL:
    ...
    //|  blt <1
    //|  ins_next_
    dasm_put(Dst, 6642, 3, ~LJ_TNIL, 2, 5);
#line 3183 "biggy.dasc"
  ...
  case BC_UGET:
    ...
    //|  strd CARG3, CARG4, [BASE, RA]
    //|   ins_next3
    dasm_put(Dst, 6677, offsetof(GCfuncL, uvptr), DtA(->v), 2, 5);
#line 3199 "biggy.dasc"
  ...
  case BC_USETV:
    ...
    //|.endif
    //|  b <1
    dasm_put(Dst, 6706, offsetof(GCfuncL, uvptr), DtA(->marked), DtA(->closed), DtA(->v), LJ_GC_BLACK, -LJ_TISGCV, 2, 5, -(LJ_TISNUM - LJ_TISGCV), Dt4(->gch.marked), -GG_DISP2G, LJ_GC_WHITES);
#line 3235 "biggy.dasc"
  ...
  case BC_USETS:
    ...
    //|.endif
    //|  b <1
    dasm_put(Dst, 6786, offsetof(GCfuncL, uvptr), 2, ~LJ_TSTR, DtA(->marked), DtA(->v), DtA(->closed), LJ_GC_BLACK, Dt5(->marked), 2, 5, LJ_GC_WHITES, -GG_DISP2G);
#line 3269 "biggy.dasc"
  ...
  case BC_USETN:
    ...
    //|  strd CARG3, CARG4, [CARG2]
    //|   ins_next3
    dasm_put(Dst, 6859, offsetof(GCfuncL, uvptr), DtA(->v), 2, 5);
#line 3283 "biggy.dasc"
  ...
  case BC_USETP:
    ...
    //|  str RC, [CARG2, #4]
    //|   ins_next3
    dasm_put(Dst, 6889, offsetof(GCfuncL, uvptr), DtA(->v), 2, 5);
#line 3296 "biggy.dasc"
  ...
  case BC_UCLO:
    ...
    //|1:
    //|  ins_next
    dasm_put(Dst, 6916, Dt1(->openupval), 2, Dt1(->base), Dt1(->base), 2, 5);
#line 3312 "biggy.dasc"
  ...
  case BC_FNEW:
    ...
    //|  strd CARG1, CARG2, [BASE, RA]
    //|   ins_next3
    dasm_put(Dst, 6957, Dt1(->base), 2, Dt1(->base), ~LJ_TFUNC, 2, 5);
...
#line 3340 "biggy.dasc"
    ...
    //|  bhs >5
    //|1:
    dasm_put(Dst, 6998, DISPATCH_GL(gc.total), DISPATCH_GL(gc.threshold), Dt1(->base));
...
#line 3362 "biggy.dasc"
    ...
    //|  mov CARG1, L
    //|  b <1
    dasm_put(Dst, 7042, Dt1(->base), ~LJ_TTAB, 2, 5);
...
#line 3387 "biggy.dasc"
  ...
  case BC_TGETV:
    ...
    //|  b ->vmeta_tgetv
    dasm_put(Dst, 7096, 21, 13, -LJ_TTAB, -LJ_TISNUM, Dt6(->array), Dt6(->asize), 3, -LJ_TNIL, 2, 5, Dt6(->metatable), Dt6(->nomm), 1<<MM_index, 21);
...
#line 3429 "biggy.dasc"
  ...
  case BC_TGETS:
    ...
    //|4:  // Follow hash chain.
    //|  cmp NODE:INS, #0
    dasm_put(Dst, 7207, 21, 2, -LJ_TTAB, Dt6(->hmask), Dt5(->hash), Dt6(->node), 1, 3, DtB(->key), DtB(->val), DtB(->next), -LJ_TSTR, -LJ_TNIL, 2, 5);
#line 3464 "biggy.dasc"
    ...
    //|  b ->vmeta_tgets
    dasm_put(Dst, 7297, Dt6(->metatable), ~LJ_TNIL, Dt6(->nomm), 1<<MM_index);
#line 3477 "biggy.dasc"
  ...
  case BC_TGETB:
    ...
    //|  bne <1				// 'no __index' flag set: done.
    //|  b ->vmeta_tgetb
    dasm_put(Dst, 7330, 21, -LJ_TTAB, Dt6(->asize), Dt6(->array), -LJ_TNIL, 2, 5, Dt6(->metatable), Dt6(->nomm), 1<<MM_index);
#line 3506 "biggy.dasc"
  ...
  case BC_TSETV:
    ...
    //|  beq <1				// No metatable: done.
    //|  ldrb RA, TAB:RA->nomm
    dasm_put(Dst, 7406, 21, 13, -LJ_TTAB, -LJ_TISNUM, Dt6(->array), Dt6(->asize), 3, -LJ_TNIL, Dt6(->marked), LJ_GC_BLACK, 2, 5, Dt6(->metatable));
#line 3542 "biggy.dasc"
    ...
    //|  beq ->BC_TSETS_Z
    //|  b ->vmeta_tsetv
    dasm_put(Dst, 7497, Dt6(->nomm), 1<<MM_newindex, 21, 5, DISPATCH_GL(gc.grayagain), LJ_GC_BLACK, DISPATCH_GL(gc.grayagain), Dt6(->marked), Dt6(->gclist), -LJ_TSTR);
#line 3558 "biggy.dasc"
  ...
  case BC_TSETS:
    ...
    dasm_put(Dst, 7559, 21, 2, -LJ_TTAB, Dt6(->hmask), Dt5(->hash), Dt6(->node), 1, 3, Dt6(->nomm), DtB(->key), DtB(->val.it), DtB(->next), -LJ_TSTR, Dt6(->marked), -LJ_TNIL, LJ_GC_BLACK);
#line 3592 "biggy.dasc"
    ...
    //|  mvn CARG4, #~LJ_TSTR
    //|   str STR:RC, TMPDlo
    dasm_put(Dst, 7645, DtB(->val), 2, 5, Dt6(->metatable), Dt6(->nomm), 1<<MM_newindex, Dt6(->metatable), Dt1(->base), Dt6(->nomm), 1<<MM_newindex, ~LJ_TSTR);
#line 3624 "biggy.dasc"
    ...
    //|  b <3
    dasm_put(Dst, 7726, Dt1(->base), DISPATCH_GL(gc.grayagain), LJ_GC_BLACK, DISPATCH_GL(gc.grayagain), Dt6(->marked), Dt6(->gclist));
#line 3636 "biggy.dasc"
  ...
  case BC_TSETB:
    ...
    //|  decode_RA8 RA, INS
    //|  b ->vmeta_tsetb
    dasm_put(Dst, 7768, 21, -LJ_TTAB, Dt6(->asize), Dt6(->array), -LJ_TNIL, Dt6(->marked), LJ_GC_BLACK, 2, 5, Dt6(->metatable), Dt6(->nomm), 1<<MM_newindex, 5);
#line 3672 "biggy.dasc"
    //|
    //|7:  // Possible table write barrier for the value. Skip valiswhite check.
    //|  barrierback TAB:CARG1, INS, CARG3
    //|  b <2
    dasm_put(Dst, 7861, DISPATCH_GL(gc.grayagain), LJ_GC_BLACK, DISPATCH_GL(gc.grayagain), Dt6(->marked), Dt6(->gclist));
#line 3676 "biggy.dasc"
  ...
  case BC_TSETM:
    ...
    dasm_put(Dst, 7889, 3, Dt6(->asize), 3, Dt6(->array), 3, Dt6(->marked), LJ_GC_BLACK, 2, 5, Dt1(->base), DISPATCH_GL(gc.grayagain));
#line 3716 "biggy.dasc"
    //|  b <4
    dasm_put(Dst, 7978, LJ_GC_BLACK, DISPATCH_GL(gc.grayagain), Dt6(->marked), Dt6(->gclist));
...
#line 3727 "biggy.dasc"
  ...
  case BC_CALL:
    ...
    //|  checkfunc CARG4, ->vmeta_call
    //|  ins_call
    dasm_put(Dst, 8008, 13, -LJ_TFUNC, Dt7(->field_pc), 2, 5);
...
#line 3745 "biggy.dasc"
  ...
  case BC_CALLT:
    ...
    dasm_put(Dst, 8057, -LJ_TFUNC, Dt7(->ffid), FRAME_TYPE, Dt7(->field_pc), 2, 5, 5, Dt7(->field_pc), PC2PROTO(k));
#line 3788 "biggy.dasc"
    ...
    //|  movne CARG4, #0			// Clear ffid if no Lua function below.
    //|  b <1
    dasm_put(Dst, 8157, FRAME_VARG, FRAME_TYPEP, FRAME_TYPE);
#line 3796 "biggy.dasc"
  ...
  case BC_ITERC:
    ...
    //|  checkfunc CARG4, ->vmeta_call
    //|  ins_call
    dasm_put(Dst, 8184, -LJ_TFUNC, Dt7(->field_pc), 2, 5);
#line 3814 "biggy.dasc"
  ...
  case BC_ITERN:
    ...
    //|  ldrh RB, [PC, #-2]
    dasm_put(Dst, 8227, Dt6(->asize), Dt6(->array), 3, -LJ_TNIL, ~LJ_TISNUM, 2, 2, 5, Dt6(->hmask), Dt6(->node), 1, 3, DtB(->val), -LJ_TNIL);
...
#line 3867 "biggy.dasc"
  ...
  case BC_ISNEXT:
    ...
    //|   ins_next2
    //|  b <1
    dasm_put(Dst, 8353, 2, -LJ_TFUNC, Dt8(->ffid), -LJ_TTAB, -LJ_TNIL, FF_next_N, 2, 5, BC_JMP, BC_ITERC);
#line 3898 "biggy.dasc"
  ...
  case BC_VARG:
    ...
    //|  ldr BASE, L->base
    //|  add RA, BASE, RA
    dasm_put(Dst, 8430, 21, 13, FRAME_VARG, ~LJ_TNIL, 2, 5, Dt1(->maxstack), Dt1(->top), Dt1(->base), Dt1(->base));
...
#line 3968 "biggy.dasc"
  ...
  case BC_RET:
    ...
    //|  add RA, BASE, RA
    dasm_put(Dst, 8563, FRAME_TYPE, FRAME_VARG, 5, 21, Dt7(->field_pc), PC2PROTO(k), 2, 5, ~LJ_TNIL);
...
#line 4025 "biggy.dasc"
  ...
  case BC_RET0: case BC_RET1:
    ...
    //|   ldreq INS, [PC, #-4]
    //|  bne ->BC_RETV1_Z
    dasm_put(Dst, 8683, FRAME_TYPE, FRAME_VARG);
...
#line 4043 "biggy.dasc"
    ...
    //|  add RC, RC, #8
    //|  b <5
    dasm_put(Dst, 8719, 21, Dt7(->field_pc), PC2PROTO(k), 2, 5, ~LJ_TNIL);
...
#line 4090 "biggy.dasc"
    ...
    if (!vk) {
      ...
      //|  blt >4
      //|  cmp CARG1, CARG3
      dasm_put(Dst, 8776, -LJ_TISNUM, -LJ_TISNUM, -LJ_TISNUM);
...
#line 4149 "biggy.dasc"
    if (!vk) {
      ...
      //|  blt >8
      //|.endif
      dasm_put(Dst, 8902, -LJ_TISNUM, -LJ_TISNUM);
...
#line 4236 "biggy.dasc"
    if (op == BC_JITERL) {
      ...
      //|  bne =>BC_JLOOP
      dasm_put(Dst, 9004, -LJ_TNIL, BC_JLOOP);
#line 4240 "biggy.dasc"
      ...
      //|  strdne CARG1, CARG2, [RA, #-8]
      dasm_put(Dst, 9016, 2, -LJ_TNIL);
#line 4246 "biggy.dasc"
    }
    //|  ins_next
    dasm_put(Dst, 9030, 2, 5);
...
#line 4284 "biggy.dasc"
  ...
  case BC_IFUNCF:
    ...
    //|  cmp RA, CARG1
    //|  bhi ->vm_growstack_l
    dasm_put(Dst, 9079, Dt1(->maxstack), 4+PC2PROTO(numparams), 4+PC2PROTO(k));
...
#line 4310 "biggy.dasc"
    ...
    //|   mvn CARG4, #~LJ_TNIL
    //|  blo >3
    dasm_put(Dst, 9101, 3, ~LJ_TNIL);
#line 4315 "biggy.dasc"
    if (op == BC_JFUNCF) {
      //|  decode_RD RC, INS
      //|  b =>BC_JLOOP
      dasm_put(Dst, 9116, BC_JLOOP);
#line 4318 "biggy.dasc"
    } else {
      //|  ins_next3
      dasm_put(Dst, 9122, 2, 5);
...
#line 4333 "biggy.dasc"
  ...
  case BC_IFUNCV:
    ...
    //|3:
    //|  ins_next
    dasm_put(Dst, 9147, Dt1(->maxstack), 8+FRAME_VARG, 4+PC2PROTO(k), 4+PC2PROTO(numparams), ~LJ_TNIL, 2, 5);
#line 4364 "biggy.dasc"
  ...
  case BC_FUNCCW:
    ...
    if (op == BC_FUNCC) {
      ...
      dasm_put(Dst, 9215, Dt8(->f));
#line 4371 "biggy.dasc"
    } else {
      //|  ldr CARG4, [DISPATCH, #DISPATCH_GL(wrapf)]
      dasm_put(Dst, 9220, DISPATCH_GL(wrapf));
#line 4373 "biggy.dasc"
    ...
    //|   cmp CARG2, CARG1
    //|  str RC, L->top
    dasm_put(Dst, 9226, Dt1(->maxstack), Dt1(->base), Dt1(->top));
#line 4380 "biggy.dasc"
    if (op == BC_FUNCCW) {
      //|  ldr CARG2, CFUNC:CARG3->f
      dasm_put(Dst, 9240, Dt8(->f));
#line 4382 "biggy.dasc"
    ...
    //|  b ->vm_returnc
    dasm_put(Dst, 9245, LJ_VMST_C, DISPATCH_GL(vmstate), Dt1(->base), LJ_VMST_INTERP, Dt1(->top), DISPATCH_GL(vmstate));
